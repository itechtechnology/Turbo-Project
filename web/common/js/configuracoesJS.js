...
$.tools.validator.fn("[type=time]", {br: "informe um hora válida"}, function(input, value) {
        return /^\d\d:\d\d$/.test(value);
});

$.tools.validator.fn("[data-equals]", {br: "Valor não confere com o campo $1"}, function(input) {
