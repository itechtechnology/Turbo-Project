<?php
    /**
     * Classe Genérica para manipulação dos registros de uma base de dados
     * esta classe irá extender todas as outras classes de manipulação de dados
     * a mesma já extend TRecord;
     *
     * @author: Anderson Rodrigues
     * @name: ProjetoRecord
     * Data: 13/05/2011
     * @version: 1.0.0.27
     * Modificada: 17/05/2011
     * Descrição: Classe genérica para manipulação de registros de uma base de ados
     */
  abstract class ManipulaBanco extends TRecord
  {
     ...
     *
     * @param <object> $objeto
     * @return <array> array contendo variaveis dos atributos de um objeto
     */
