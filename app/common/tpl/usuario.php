<?php
	...
	switch($acao){
		...
		case "add2":
			...
			if ($erros == NULL) $status = 3; //Passo para o próximo passo do cadastro
		break;
		...
		case "add3":
			...
			if ($erros == NULL) $status = 4; //Passo para o próximo passo do cadastro
		break;
		...
		case "add4":
			...
			if ($erros == NULL) $status = 5; //Validação final
		break;
		
		
		case "v1": //Vplta para etapa 1 do cadastro
			$status = 1;			
		break;
		
		case "v2": //Vplta para etapa 2 do cadastro
			$status = 2;			
		break;
		
		case "v3": //Vplta para etapa 3 do cadastro
			$status = 3;			
		break;
		
		case "v4": //Vplta para etapa 4 do cadastro
			$status = 4;			
		break;
