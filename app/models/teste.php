...
include 'usuario/Endereco.class.php';
include 'usuario/Habilidade.class.php';
include 'usuario/Usuario.class.php';

include 'usuario/Mensagem.class.php';
include 'usuario/Sessao.class.php';
...
$user->criaSessao("marco", md5("123"));

$x = $user->verificaSessao();
echo $x;
